...
class Auth:
    ...
    def get_reset_password_token(self, email: str) -> str:
        """fings user corresponding to email, generates
        a UUID and updates the user's reset token
        """
        user = self._db.find_user_by(email=email)
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        """finds user using reset_token and updates the hashedpw
        for that user before setting the reset token to none
        """
